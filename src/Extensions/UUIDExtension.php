 ...
 *
 * @property Site|SiteAlias|SiteClient|SiteErrorCount|SiteHost|SiteHourlyRate|SiteLink|SiteMember|SitePassword|SiteRelease|SiteReviewResult|SiteTimeRecord|SiteUpdate|SitesPage|SitePasswordRequest|UUIDExtension $owner
